...
// export function Dock({ direction = "bottom", className, children, ...props }: DockProps) {
//   return (
//     <div
//       className={cn(
//         "fixed flex gap-4 p-2 bg-background/80 backdrop-blur-2xl rounded-2xl shadow-lg",
//         direction === "top" && "top-4 inset-x-4",
//         direction === "bottom" && "bottom-4 inset-x-4",
//         direction === "left" && "left-4 inset-y-4 flex-col",
//         direction === "right" && "right-4 inset-y-4 flex-col",
//         direction === "middle" && "inset-x-4 bottom-4 justify-center",
//         className,
//       )}
//       {...props}
//     >
...
// FILE: components/skill-space/dock.tsx
